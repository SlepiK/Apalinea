...
namespace Energyleaf::Stream::V1::Expression {
    class ToDtFloatExpression : public Expression {
    public:
        static constexpr std::string_view IDENTIFIER = Types::Datatype::DtFloat::IDENTIFIER;

        ToDtFloatExpression() : Expression({Types::Datatype::DtInt8::IDENTIFIER,Types::Datatype::DtInt16::IDENTIFIER,Types::Datatype::DtInt32::IDENTIFIER,
        ...
        void execute() override {
            ...
            if (Types::Datatype::DtRegistry::isRegistered(Types::Datatype::DtInt8::IDENTIFIER) &&
                ...
                this->data = Types::Datatype::DtFloat((static_cast<const Types::Datatype::DtInt8 &>(expData)).toInt8());
                ...
                this->data = Types::Datatype::DtFloat(
                ...
                this->data = Types::Datatype::DtFloat(
                        static_cast<float>((static_cast<const Types::Datatype::DtInt32 &>(expData)).toInt32()));
                ...
                this->data = Types::Datatype::DtFloat(
                        static_cast<float>((static_cast<const Types::Datatype::DtInt64 &>(expData)).toInt64()));
                ...
                this->data = Types::Datatype::DtFloat(
                        static_cast<float>((static_cast<const Types::Datatype::DtUInt32 &>(expData)).toUInt32()));
                ...
                this->data = Types::Datatype::DtFloat(
                        static_cast<float>((static_cast<const Types::Datatype::DtUInt64 &>(expData)).toUInt64()));
                ...
                this->data = Types::Datatype::DtFloat(
                        static_cast<float>((static_cast<const Types::Datatype::DtFloat &>(expData)).toFloat()));
                ...
                this->data = Types::Datatype::DtFloat(
                        static_cast<float>((static_cast<const Types::Datatype::DtDouble &>(expData)).toDouble()));
                ...
                this->data = Types::Datatype::DtFloat(
                        static_cast<float>((static_cast<const Types::Datatype::DtSizeT &>(expData)).toSizeT()));
                ...
                this->data = Types::Datatype::DtFloat(
                        static_cast<float>((static_cast<const Types::Datatype::DtInt &>(expData)).toInt()));
                ...
                this->data = Types::Datatype::DtFloat(static_cast<float>((static_cast<const Types::Datatype::DtBool &>(expData)).toBool()));
            } else {
