...
namespace Apalinea::Expression::DataType {
    ...
    public:
        static constexpr std::string_view IDENTIFIER = Core::Types::Datatype::DtUInt64::IDENTIFIER;
        ...
        void execute() override {
            ...
            if(this->tuple.containsItem(this->entry)) {
                this->data = this->tuple.getEntry(this->entry).get<Core::Types::Datatype::DtUInt64>();
            } else {
    ...
    private:
        ...
        std::string entry;
        Core::Types::Datatype::DtUInt64 data;
        bool load;
    };
}
