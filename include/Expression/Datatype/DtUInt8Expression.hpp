...
namespace Apalinea::Expression::DataType {
    ...
    public:
        static constexpr std::string_view IDENTIFIER = Core::Types::Datatype::DtUInt8::IDENTIFIER;
        ...
        void execute() override {
            ...
            if(this->tuple.containsItem(this->entry)) {
                this->data = this->tuple.getEntry(this->entry).get<Core::Types::Datatype::DtUInt8>();
            } else {
    ...
    private:
        ...
        std::string entry;
        Core::Types::Datatype::DtUInt8 data;
        bool load;
    };
}
