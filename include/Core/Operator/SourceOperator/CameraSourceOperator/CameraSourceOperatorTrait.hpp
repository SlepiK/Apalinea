...
namespace Energyleaf::Stream::V1::Core::Operator::SourceOperator::Trait {
    template<typename T>
    struct IsBasedOnAbstractCamera {
        static constexpr bool value = std::is_base_of<Energyleaf::Stream::V1::Extras::Vision::AbstractCamera<typename T::CameraConfig>, T>::value;
