...
namespace Energyleaf::Stream::V1::Core::Operator::PipeOperator {
    class DetectorPipeOperator
            : public Energyleaf::Stream::V1::Operator::AbstractPipeOperator<Energyleaf::Stream::V1::Tuple::Tuple<Energyleaf::Stream::V1::Types::Image>,
                    Energyleaf::Stream::V1::Tuple::Tuple<std::size_t>> {
    public:
    ...
    protected:
        void work(Energyleaf::Stream::V1::Tuple::Tuple<Energyleaf::Stream::V1::Types::Image> &inputTuple,
                  Energyleaf::Stream::V1::Tuple::Tuple<std::size_t> &outputTuple) override {
            std::size_t foundPixel = 0;
            Energyleaf::Stream::V1::Types::Image image = inputTuple.getItem<Energyleaf::Stream::V1::Types::Image>(0).getData();
